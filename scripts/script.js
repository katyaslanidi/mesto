...
const closePopupButton = document.querySelector('.profile-popup__button-close');
...
const closeAddButton = document.querySelector('.add-card-popup__button-close');
const cardPopup = document.querySelector('.card-popup');
const closeImage = document.querySelector('.card-popup__button-close');

...
const submitButtonCard = document.querySelector('.add-card-popup__button');
...
function addNewCard(e) {
  ...
  submitButtonCard.classList.add('popup__button_invalid');
  submitButtonCard.classList.remove('popup__button_valid');
  closeAddCardPopup();
}
